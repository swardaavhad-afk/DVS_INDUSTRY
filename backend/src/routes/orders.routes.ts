...
import {
  ...
  clientOrderIdParamSchema,
  clientOrderQuerySchema,
  dispatchOrderSchema,
...
router.get('/statistics', authorize(...ADMIN_MGR), asyncHandler(OrdersController.getStatistics));
